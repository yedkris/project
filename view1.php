...
<div style="border:1px black">
            ...
            $sql=mysql_query("select * from reg1");
       ...
       $g=$ar['Age'];
           ...
           <br>
                                            ...
                                            <tr> <td><br></br><b>category:<FONT COLOR="ORANGE" size="4"><?php echo $ah;?></FONT></b></td></tr>
         ...
         <td><a href="update1.php?id=<?php echo $c;?>"><font size="6" color="blue" align="center">Update</font></a> </td>
          ...
          <tr><td>-------------------------------------------------</td></tr>                                 
            ...
            $sql=mysql_query("select * from reg2");
            while($ar=mysql_fetch_array($sql))
            {
              $b=$ar['Breed'];  
              $j=$ar['color'];  
       ...
       $g=$ar['Age'];
          ...
          <tr><td><strong>prize:<FONT COLOR="ORANGE" size="4"><?php echo $i;?> Rs</FONT></strong></td></tr>
           <tr><td><strong>Breed:<FONT COLOR="black" size="4"><?php echo $b;?> </FONT></strong></td></tr>
            <tr><td><strong>Color:<FONT COLOR="black" size="4"><?php echo $j;?> </FONT></strong></td></tr>
          <tr><td><strong>Age:<FONT COLOR="black" size="4"><?php echo $g;?> </FONT></strong></td></tr>
         <td><input type="submit" name="submit12" value="Approve" style="border-color:orange"> </td>
