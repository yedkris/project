...
<div style="border:1px black">
           ...
           $k = $_GET['id'];
            $sql=mysql_query("select * from reg1 where status='1'");
        ...
        <td><a href="delete.php?id=<?php echo $c;?>"><font size="6" color="blue" align="center">remove item from the cart</font></a> </td>
          <tr><td>-------------------------------------------------</td></tr>                                 
               <?php
            }
            ?>
